# robimy zakupy w petli
# sorry nie ma tego produktu
# wprowadzamy magazyn danych przechowujacy ilosc produktu. "sorry nie ma tego produktu"
# dodanie produltu do sklepu
# get - pierwsza wartosc argument, druga - wartość która ma zostac zwrocona
